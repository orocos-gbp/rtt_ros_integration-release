...
Name:           ros-noetic-rtt-tf2-msgs
Version:        2.10.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS rtt_tf2_msgs package
...
BuildRequires:  ros-noetic-rtt-actionlib-msgs
...
%description
Provides an rtt typekit for ROS tf2_msgs messages. It allows you to use ROS
...
manually modified. See the http://ros.org/wiki/tf2_msgs documentation for the
